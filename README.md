        	...
        	<div class="card">
        		...
        		<div class="cardItem">
        			...
        			<div class="chevronBox" style="transform: rotate(0deg);">
						<div :style="{'animation-delay':`0s`}" class="zwyChevron" :key="index" ></div>
						<div :style="{'animation-delay':`1s`}" class="zwyChevron" :key="index" ></div>
						<div :style="{'animation-delay':`2s`}" class="zwyChevron" :key="index" ></div>
